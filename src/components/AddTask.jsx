...
const AddTask = () => {
  ...
  return (
    <div className="sticky top-0 left-0 right-0 z-10 pb-5 bg-white">
      <div className="text-center mb-10 font-bold text-2xl">
        <h1>CREATE YOUR TASK TODO LIST</h1>
      </div>
      {/* create post section */}
      <section className="space-x-4 w-max mx-auto shadow-sm-5">
        <input
      ...
      {/* filter post section */}
      <section className="flex w-max mx-auto gap-3 items-center my-3">
        <p>Filter: </p>
        {/* show all tasks */}
        <button
          onClick={() => {
